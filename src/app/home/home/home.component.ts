...
export class HomeComponent implements OnInit {
  ...
  ngDoCheck() {
    ...
    this.patientsDataService.metaData.next({property:"twitter:card" , content:"India Covid-19 - Corona Virus Dashboard India (Live) - " + this.totalConfirmedCases + " confirmed cases and " + this.totalDeathCases +" deaths in India from Covid-19 Virus Outbreak"});
    this.patientsDataService.metaData.next({property:"twitter:title" , content:"India Covid-19 - Corona Virus Dashboard India (Live) - " + this.totalConfirmedCases + " confirmed cases and " + this.totalDeathCases +" deaths in India from Covid-19 Virus Outbreak"});
